 ...
 */
export class DeepRaven extends Core.APIClient {
  apiKey: string;
   ...
   */
  constructor({
    baseURL = Core.readEnv('DEEP_RAVEN_BASE_URL'),
    apiKey = Core.readEnv('DEEPRAVEN_API_KEY'),
    ...opts
  }: ClientOptions = {}) {
    if (apiKey === undefined) {
    ...
    super({
      ...
      baseURLOverridden: baseURL ? baseURL !== 'https://deepraven.ai' : false,
