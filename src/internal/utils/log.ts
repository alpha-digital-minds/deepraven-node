...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: DeepRaven): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: DeepRaven): Logger {
